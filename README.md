...
- 🎯 Entry points to execute your program using `python -m <airflow_processing_service>` or `$ airflow_processing_service` with basic CLI argument parsing.
...
```py
from airflow_processing_service import BaseClass
from airflow_processing_service import base_function
