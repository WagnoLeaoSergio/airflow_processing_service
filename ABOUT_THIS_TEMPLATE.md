...
├── airflow_processing_service             # The main python package for the project
...
e.g: `cat airflow_processing_service/VERSION` will get the project version without harming
